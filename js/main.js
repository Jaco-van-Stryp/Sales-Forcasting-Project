...
function updateExample() {
    var smartValue = ["Chocolate", "TV", "Tissue Box", "Paper", "Floor", "Glasses", "Newspaper", "Glow Stick", "Soy Sauce Packet", "Lamp Shade", "Bracelet", "Candy Wrapper", "Lip Gloss", "Smart Watch", "Soap", "Tooth picks", "Sun Glasses", "Photo Album", "Video Games", "Bag"]
    var num = Math.floor(Math.random() * 19) + 1
    console.log(num); //TODO remove line
...
function searchDatabase() {
    ...
    console.log(searchValue); //Logs to the console //TODO remove line
